...
class BuildData(object):
    ...
    # os.makedirs(cfg.TRAININGSET_PATH, exist_ok=True)
    # os.makedirs(cfg.VALIDATIONSET_PATH, exist_ok=True)
    # os.makedirs(cfg.TESTSET_PATH, exist_ok=True)
    # os.makedirs(cfg.SAMPLE_IMAGE_PATH, exist_ok=True)

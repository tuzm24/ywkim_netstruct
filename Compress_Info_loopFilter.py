...
class ResidualEncoder(nn.Module):
    ...
    def __init__(self, num_input_channel=1, num_output_channel=64, bn_size=4, growth_rate=32, memory_efficient=False,
        ...
        self.channel_wise_features.add_module('c_relu1', nn.ReLU(inplace=True))
        ...
        self.channel_wise_features.add_module('c_relu2', nn.ReLU(inplace=True))
        ...
        # self.spatial_wise_features.add_module('s_relu1', nn.ReLU(inplace=True))
        ...
        # self.spatial_wise_features.add_module('s_relu2', nn.ReLU(inplace=True))
...
class PixToPixReidualDenseNet(nn.Module):
    ...
    def __init__(self, num_input_channel=3, num_output_channel=1, bn_size=4, growth_rate=24, memory_efficient=False,
                 middle_output_channel=32, block_config=(8,12,10), additional_vector_channels = 64):
